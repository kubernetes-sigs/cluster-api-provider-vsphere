...
e2e-templates: ## Generate e2e cluster templates
	...
	# for hardware version template
	"$(KUSTOMIZE)" --load-restrictor LoadRestrictionsNone build $(E2E_TEMPLATE_DIR)/kustomization/hw > $(E2E_TEMPLATE_DIR)/cluster-template-hw.yaml
