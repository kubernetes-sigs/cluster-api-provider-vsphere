...
CAPI_HACK_TOOLS_VER := 43fefdcb9046d12707a6a9114b3427fc20d4341f # Note: this the commit ID of CAPI main 04.09.2026.
...
generate-e2e-templates: $(KUSTOMIZE) $(addprefix generate-e2e-templates-, v1.15 v1.16 v1.17 main) ## Generate test templates for all branches
...
.PHONY: generate-e2e-templates-v1.17
generate-e2e-templates-v1.17: $(KUSTOMIZE)
	"$(KUSTOMIZE)" --load-restrictor LoadRestrictionsNone build "$(E2E_GOVMOMI_TEMPLATE_DIR)/v1.17/clusterclass" > "$(E2E_GOVMOMI_TEMPLATE_DIR)/v1.17/clusterclass-quick-start.yaml"
	"$(KUSTOMIZE)" --load-restrictor LoadRestrictionsNone build "$(E2E_GOVMOMI_TEMPLATE_DIR)/v1.17/workload" > "$(E2E_GOVMOMI_TEMPLATE_DIR)/v1.17/cluster-template-workload.yaml"

	"$(KUSTOMIZE)" --load-restrictor LoadRestrictionsNone build "$(E2E_SUPERVISOR_TEMPLATE_DIR)/v1.17/clusterclass" > "$(E2E_SUPERVISOR_TEMPLATE_DIR)/v1.17/clusterclass-quick-start-supervisor.yaml"
	"$(KUSTOMIZE)" --load-restrictor LoadRestrictionsNone build "$(E2E_SUPERVISOR_TEMPLATE_DIR)/v1.17/workload" > "$(E2E_SUPERVISOR_TEMPLATE_DIR)/v1.17/cluster-template-workload-supervisor.yaml"
