...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InfrastructurePolicyRef) DeepCopyInto(out *InfrastructurePolicyRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InfrastructurePolicyRef.
func (in *InfrastructurePolicyRef) DeepCopy() *InfrastructurePolicyRef {
	if in == nil {
		return nil
	}
	out := new(InfrastructurePolicyRef)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VSphereMachineSpec) DeepCopyInto(out *VSphereMachineSpec) {
	*out = *in
	...
	if in.InfrastructurePolicies != nil {
		in, out := &in.InfrastructurePolicies, &out.InfrastructurePolicies
		*out = make([]InfrastructurePolicyRef, len(*in))
		for i := range *in {
			(*out)[i] = (*in)[i]
		}
	}
