...
var unmarshalWarnAsFatal = []v1alpha2.UnmarshalINIOptionFunc{v1alpha2.WarnAsFatal}
...
type codecTestCase struct {
	testName         string
	iniString        string
	configObj        v1alpha2.CPIConfig
	expectedError    error
	unmarshalOptions []v1alpha2.UnmarshalINIOptionFunc
}
...
`,
			configObj: v1alpha2.CPIConfig{
				Global: v1alpha2.CPIGlobalConfig{
					Username:    "user",
					Password:    "password",
					Datacenters: "us-west",
					ClusterID:   "cluster-namespace/cluster-name",
				},
				VCenter: map[string]v1alpha2.CPIVCenterConfig{
					"0.0.0.0": {},
				},
				Workspace: v1alpha2.CPIWorkspaceConfig{
					Server:     "0.0.0.0",
					Datacenter: "us-west",
					Folder:     "kubernetes",
					Datastore:  "default",
...
`,
			configObj: v1alpha2.CPIConfig{
				...
				ProviderConfig: v1alpha2.CPIProviderConfig{
					Cloud: &v1alpha2.CPICloudConfig{
