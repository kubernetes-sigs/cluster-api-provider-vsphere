...
func Convert_v1beta1_NetworkDeviceSpec_To_v1alpha3_NetworkDeviceSpec(in *infrav1beta1.NetworkDeviceSpec, out *NetworkDeviceSpec, s apiconversion.Scope) error {
