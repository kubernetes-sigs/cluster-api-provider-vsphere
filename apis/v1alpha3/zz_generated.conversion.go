...
func autoConvert_v1beta1_VirtualMachineCloneSpec_To_v1alpha3_VirtualMachineCloneSpec(in *v1beta1.VirtualMachineCloneSpec, out *VirtualMachineCloneSpec, s conversion.Scope) error {
	...
	// WARNING: in.NestedHVEnabled requires manual conversion: does not exist in peer-type
	// WARNING: in.FtEncryptionMode requires manual conversion: does not exist in peer-type
	// WARNING: in.MigrateEncryption requires manual conversion: does not exist in peer-type
	return nil
}
