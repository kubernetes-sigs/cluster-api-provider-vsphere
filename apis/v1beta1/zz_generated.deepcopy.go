...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FailureDomainNetwork) DeepCopyInto(out *FailureDomainNetwork) {
	*out = *in
	if in.DHCP4 != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FailureDomainNetwork.
func (in *FailureDomainNetwork) DeepCopy() *FailureDomainNetwork {
	if in == nil {
		return nil
	}
	out := new(FailureDomainNetwork)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Topology) DeepCopyInto(out *Topology) {
	*out = *in
	...
	if in.NetworkConfigs != nil {
		...
		*out = make([]FailureDomainNetwork, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
