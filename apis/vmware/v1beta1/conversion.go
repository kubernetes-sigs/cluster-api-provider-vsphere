...
func Convert_v1beta1_ProviderServiceAccountSpec_To_v1beta2_ProviderServiceAccountSpec(in *ProviderServiceAccountSpec, out *vmwarev1.ProviderServiceAccountSpec, s apimachineryconversion.Scope) error {
	if err := autoConvert_v1beta1_ProviderServiceAccountSpec_To_v1beta2_ProviderServiceAccountSpec(in, out, s); err != nil {
		return err
	}
...
func Convert_v1beta2_ProviderServiceAccountSpec_To_v1beta1_ProviderServiceAccountSpec(in *vmwarev1.ProviderServiceAccountSpec, out *ProviderServiceAccountSpec, s apimachineryconversion.Scope) error {
	if err := autoConvert_v1beta2_ProviderServiceAccountSpec_To_v1beta1_ProviderServiceAccountSpec(in, out, s); err != nil {
		return err
	}
