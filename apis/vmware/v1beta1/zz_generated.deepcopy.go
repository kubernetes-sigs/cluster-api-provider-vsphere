...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TopologyMachineDeploymentAffinityTerm) DeepCopyInto(out *TopologyMachineDeploymentAffinityTerm) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TopologyMachineDeploymentAffinityTerm.
func (in *TopologyMachineDeploymentAffinityTerm) DeepCopy() *TopologyMachineDeploymentAffinityTerm {
	if in == nil {
		return nil
	}
	out := new(TopologyMachineDeploymentAffinityTerm)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VSphereMachineMachineDeploymentMachineAntiAffinity) DeepCopyInto(out *VSphereMachineMachineDeploymentMachineAntiAffinity) {
	*out = *in
	if in.PreferredDuringSchedulingPreferredDuringExecution != nil {
		...
		*out = make([]TopologyMachineDeploymentAffinityTerm, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
