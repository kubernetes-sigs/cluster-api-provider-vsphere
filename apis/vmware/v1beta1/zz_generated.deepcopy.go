...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VSphereClusterPlacement) DeepCopyInto(out *VSphereClusterPlacement) {
	*out = *in
	if in.WorkerAntiAffinity != nil {
		in, out := &in.WorkerAntiAffinity, &out.WorkerAntiAffinity
		*out = new(VSphereClusterWorkerAntiAffinity)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VSphereClusterPlacement.
func (in *VSphereClusterPlacement) DeepCopy() *VSphereClusterPlacement {
	if in == nil {
		return nil
	}
	out := new(VSphereClusterPlacement)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VSphereClusterWorkerAntiAffinity) DeepCopyInto(out *VSphereClusterWorkerAntiAffinity) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VSphereClusterWorkerAntiAffinity.
func (in *VSphereClusterWorkerAntiAffinity) DeepCopy() *VSphereClusterWorkerAntiAffinity {
	if in == nil {
		return nil
	}
	out := new(VSphereClusterWorkerAntiAffinity)
