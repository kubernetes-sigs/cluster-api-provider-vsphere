...
/*
GetHaproxyProcessInfo Return HAProxy process information
...
func (a *InformationApiService) GetHaproxyProcessInfo(ctx _context.Context) (ProcessInfo, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  ProcessInfo
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/services/haproxy/info"
...
/*
GetInfo Return API, hardware and OS information
Return API, hardware and OS information
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return Info
*/
func (a *InformationApiService) GetInfo(ctx _context.Context) (Info, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
