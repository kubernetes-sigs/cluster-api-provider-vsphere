...
func (r vsphereDeploymentZoneReconciler) reconcileFailureDomain(ctx context.Context, deploymentZoneCtx *capvcontext.VSphereDeploymentZoneContext, vsphereFailureDomain *infrav1.VSphereFailureDomain) error {
	...
	deprecatedconditions.MarkTrue(deploymentZoneCtx.VSphereDeploymentZone, infrav1.VSphereFailureDomainValidatedCondition)
	deprecatedv1beta2conditions.Set(deploymentZoneCtx.VSphereDeploymentZone, metav1.Condition{
		Type:   infrav1.VSphereDeploymentZoneFailureDomainValidatedV1Beta2Condition,
...
func (r vsphereDeploymentZoneReconciler) reconcileTopology(ctx context.Context, deploymentZoneCtx *capvcontext.VSphereDeploymentZoneContext, vsphereFailureDomain *infrav1.VSphereFailureDomain) error {
	...
	if datastore := topology.Datastore; datastore != "" {
		if _, err := deploymentZoneCtx.AuthSession.Finder.Datastore(ctx, datastore); err != nil {
			deprecatedconditions.MarkFalse(deploymentZoneCtx.VSphereDeploymentZone, infrav1.VSphereFailureDomainValidatedCondition, infrav1.DatastoreNotFoundReason, clusterv1beta1.ConditionSeverityError, "datastore %s is misconfigured", datastore)
			deprecatedv1beta2conditions.Set(deploymentZoneCtx.VSphereDeploymentZone, metav1.Condition{
				Type:    infrav1.VSphereDeploymentZoneFailureDomainValidatedV1Beta2Condition,
				Status:  metav1.ConditionFalse,
	...
	for _, network := range topology.Networks {
		if _, err := deploymentZoneCtx.AuthSession.Finder.Network(ctx, network); err != nil {
			deprecatedconditions.MarkFalse(deploymentZoneCtx.VSphereDeploymentZone, infrav1.VSphereFailureDomainValidatedCondition, infrav1.NetworkNotFoundReason, clusterv1beta1.ConditionSeverityError, "network %s is not found", network)
			deprecatedv1beta2conditions.Set(deploymentZoneCtx.VSphereDeploymentZone, metav1.Condition{
				Type:    infrav1.VSphereDeploymentZoneFailureDomainValidatedV1Beta2Condition,
				Status:  metav1.ConditionFalse,
	...
	for _, networkConfig := range topology.NetworkConfigurations {
		if _, err := deploymentZoneCtx.AuthSession.Finder.Network(ctx, networkConfig.NetworkName); err != nil {
			deprecatedconditions.MarkFalse(deploymentZoneCtx.VSphereDeploymentZone, infrav1.VSphereFailureDomainValidatedCondition, infrav1.NetworkNotFoundReason, clusterv1beta1.ConditionSeverityError, "network %s is not found", networkConfig.NetworkName)
			deprecatedv1beta2conditions.Set(deploymentZoneCtx.VSphereDeploymentZone, metav1.Condition{
				Type:    infrav1.VSphereDeploymentZoneFailureDomainValidatedV1Beta2Condition,
				Status:  metav1.ConditionFalse,
				Reason:  infrav1.VSphereDeploymentZoneFailureDomainNetworkNotFoundV1Beta2Reason,
	...
	if hostPlacementInfo := topology.Hosts; hostPlacementInfo != nil {
		...
		if err != nil {
			deprecatedconditions.MarkFalse(deploymentZoneCtx.VSphereDeploymentZone, infrav1.VSphereFailureDomainValidatedCondition, infrav1.HostsMisconfiguredReason, clusterv1beta1.ConditionSeverityError, "vm host affinity does not exist")
			deprecatedv1beta2conditions.Set(deploymentZoneCtx.VSphereDeploymentZone, metav1.Condition{
				Type:    infrav1.VSphereDeploymentZoneFailureDomainValidatedV1Beta2Condition,
				Status:  metav1.ConditionFalse,
...
func (r vsphereDeploymentZoneReconciler) reconcileComputeCluster(ctx context.Context, deploymentZoneCtx *capvcontext.VSphereDeploymentZoneContext, vsphereFailureDomain *infrav1.VSphereFailureDomain) error {
	...
	if err != nil {
		deprecatedconditions.MarkFalse(deploymentZoneCtx.VSphereDeploymentZone, infrav1.VSphereFailureDomainValidatedCondition, infrav1.ComputeClusterNotFoundReason, clusterv1beta1.ConditionSeverityError, "compute cluster %s not found", *computeCluster)
		deprecatedv1beta2conditions.Set(deploymentZoneCtx.VSphereDeploymentZone, metav1.Condition{
			Type:    infrav1.VSphereDeploymentZoneFailureDomainValidatedV1Beta2Condition,
			Status:  metav1.ConditionFalse,
	...
	if resourcePool := deploymentZoneCtx.VSphereDeploymentZone.Spec.PlacementConstraint.ResourcePool; resourcePool != "" {
		...
		if err != nil {
			deprecatedconditions.MarkFalse(deploymentZoneCtx.VSphereDeploymentZone, infrav1.VSphereFailureDomainValidatedCondition, infrav1.ComputeClusterNotFoundReason, clusterv1beta1.ConditionSeverityError, "resource pool owner not found")
			deprecatedv1beta2conditions.Set(deploymentZoneCtx.VSphereDeploymentZone, metav1.Condition{
				Type:    infrav1.VSphereDeploymentZoneFailureDomainValidatedV1Beta2Condition,
				Status:  metav1.ConditionFalse,
				Reason:  infrav1.VSphereDeploymentZoneFailureDomainComputeClusterNotFoundV1Beta2Reason,
		...
		if ref.Reference() != ccr.Reference() {
			deprecatedconditions.MarkFalse(deploymentZoneCtx.VSphereDeploymentZone, infrav1.VSphereFailureDomainValidatedCondition, infrav1.ResourcePoolNotFoundReason, clusterv1beta1.ConditionSeverityError, "resource pool is not owned by compute cluster")
			deprecatedv1beta2conditions.Set(deploymentZoneCtx.VSphereDeploymentZone, metav1.Condition{
				Type:    infrav1.VSphereDeploymentZoneFailureDomainValidatedV1Beta2Condition,
				Status:  metav1.ConditionFalse,
