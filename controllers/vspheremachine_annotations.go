...
func (r *VSphereMachineReconciler) updateMachineAnnotationJSON(machine *infrav1.VSphereMachine, annotation string, content map[string]interface{}) error {
...
// `content`.
func (r *VSphereMachineReconciler) updateMachineAnnotation(machine *infrav1.VSphereMachine, annotation string, content string) {
	// Get the annotations
...
func (r *VSphereMachineReconciler) machineAnnotationJSON(machine *infrav1.VSphereMachine, annotation string) (map[string]interface{}, error) {
...
func (r *VSphereMachineReconciler) machineAnnotation(machine *infrav1.VSphereMachine, annotation string) string {
