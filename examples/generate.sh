...
CAPI_MANAGER_IMAGE="${CAPI_MANAGER_IMAGE:-us.gcr.io/k8s-artifacts-prod/cluster-api/cluster-api-controller:v0.2.2}"
...
kustomize build "github.com/kubernetes-sigs/cluster-api/config/default/?ref=v0.2.2" >"${COMPONENTS_CLUSTER_API_GENERATED_FILE}"
