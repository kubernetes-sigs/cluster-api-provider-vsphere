...
if [ ! -f "$TRIVY" ]; then
  TRIVY_FILE_NAME="trivy_${VERSION}_${TRIVY_OS}-${TRIVY_ARCH}.tar.gz"
  ...
  download_and_verify "https://github.com/aquasecurity/trivy/releases/download/v${VERSION}/${TRIVY_FILE_NAME}" "${TRIVY_SHA256}" "${TOOL_BIN}/trivy.tar.gz"
