...
var VSphereCluster = conversion.NewHubSpokeConverter(&infrav1.VSphereCluster{},
	conversion.NewSpokeConverter(&infrav1beta1.VSphereCluster{}, ConvertVSphereClusterHubToV1Beta1, ConvertVSphereClusterV1Beta1ToHub),
)

// ConvertVSphereClusterV1Beta1ToHub converts a v1beta1 VSphereCluster to a hub VSphereCluster.
func ConvertVSphereClusterV1Beta1ToHub(_ context.Context, src *infrav1beta1.VSphereCluster, dst *infrav1.VSphereCluster) error {
	if err := infrav1beta1.Convert_v1beta1_VSphereCluster_To_v1beta2_VSphereCluster(src, dst, nil); err != nil {
		return err
	}
...
func ConvertVSphereClusterHubToV1Beta1(_ context.Context, src *infrav1.VSphereCluster, dst *infrav1beta1.VSphereCluster) error {
	if err := infrav1beta1.Convert_v1beta2_VSphereCluster_To_v1beta1_VSphereCluster(src, dst, nil); err != nil {
		return err
	}
