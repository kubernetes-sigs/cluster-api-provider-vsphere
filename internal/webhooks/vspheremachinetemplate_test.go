...
func TestVSphereMachineTemplate_ValidateCreate(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			vsphereMachine: createVSphereMachineTemplate("foo.com", "", "", "192.168.0.1/32", []string{}, nil, nil),
			wantErr:        true,
		},
		{
		...
		},
		{
			...
			vsphereMachine: createVSphereMachineTemplate("foo.com", "", "", "", []string{"192.168.0.1/32", "192.168.0.3"}, nil, nil),
			wantErr:        true,
		},
		{
			name:           "successful VSphereMachine creation",
			vsphereMachine: createVSphereMachineTemplate("foo.com", "", "", "", []string{"192.168.0.1/32", "192.168.0.3/32"}, nil, nil),
			wantErr:        true,
		},
		{
			name:           "incomplete hardware version",
			vsphereMachine: createVSphereMachineTemplate("foo.com", "vmx-", "", "", []string{"192.168.0.1/32", "192.168.0.3/32"}, nil, nil),
			wantErr:        true,
		},
		{
			name:           "incorrect hardware version",
			vsphereMachine: createVSphereMachineTemplate("foo.com", "vmx-0", "", "", []string{"192.168.0.1/32", "192.168.0.3/32"}, nil, nil),
			wantErr:        true,
		},
		{
			name:           "empty pciDevice",
			vsphereMachine: createVSphereMachineTemplate("foo.com", "vmx-17", "", "", []string{}, []infrav1.PCIDeviceSpec{{VGPUProfile: ""}}, nil),
			wantErr:        true,
		},
		{
			name:           "incorrect pciDevice",
			vsphereMachine: createVSphereMachineTemplate("foo.com", "vmx-17", "", "", []string{}, []infrav1.PCIDeviceSpec{{VGPUProfile: "vgpu", DeviceID: ptr.To[int32](1)}}, nil),
			wantErr:        true,
		},
		{
			name:           "incorrect pciDevice",
			vsphereMachine: createVSphereMachineTemplate("foo.com", "vmx-17", "", "", []string{}, []infrav1.PCIDeviceSpec{{VGPUProfile: "vgpu", DeviceID: ptr.To[int32](1), VendorID: ptr.To[int32](1)}}, nil),
			wantErr:        true,
		},
		{
			name:           "incomplete pciDevice",
			vsphereMachine: createVSphereMachineTemplate("foo.com", "vmx-17", "", "", []string{}, []infrav1.PCIDeviceSpec{{DeviceID: ptr.To[int32](1)}}, nil),
			wantErr:        true,
		},
		{
			name:           "incomplete pciDevice",
			vsphereMachine: createVSphereMachineTemplate("foo.com", "vmx-17", "", "", []string{}, []infrav1.PCIDeviceSpec{{VendorID: ptr.To[int32](1)}}, nil),
			wantErr:        true,
		},
		{
			name:           "successful VSphereMachine creation with PCI device",
			vsphereMachine: createVSphereMachineTemplate("foo.com", "vmx-17", "", "", []string{}, []infrav1.PCIDeviceSpec{{DeviceID: ptr.To[int32](1), VendorID: ptr.To[int32](1)}}, nil),
		},
		{
			name:           "successful VSphereMachine creation with vgpu",
			vsphereMachine: createVSphereMachineTemplate("foo.com", "vmx-17", "", "", []string{}, []infrav1.PCIDeviceSpec{{VGPUProfile: "vgpu"}}, nil),
		},
		{
			name:           "successful VSphereMachine creation with hardware version set and namingStrategy not set",
			vsphereMachine: createVSphereMachineTemplate("foo.com", "vmx-17", "", "", []string{}, nil, nil),
		},
		{
...
func TestVSphereMachineTemplate_ValidateUpdate(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			oldVSphereMachine: createVSphereMachineTemplate("foo.com", "", "", "", []string{"192.168.0.1/32"}, nil, nil),
		...
		},
		{
			...
			vsphereMachine:    createVSphereMachineTemplate("baz.com", "vmx-17", "", "", []string{"192.168.0.1/32"}, nil, nil),
			req:               &admission.Request{AdmissionRequest: admissionv1.AdmissionRequest{DryRun: ptr.To(false)}},
			wantErr:           true,
		},
		{
			name:              "pci devices cannot be updated",
			oldVSphereMachine: createVSphereMachineTemplate("foo.com", "vmx-16", "", "", []string{"192.168.0.1/32"}, []infrav1.PCIDeviceSpec{{VGPUProfile: "vgpu"}}, nil),
			vsphereMachine:    createVSphereMachineTemplate("foo.com", "vmx-16", "", "", []string{"192.168.0.1/32"}, []infrav1.PCIDeviceSpec{{VGPUProfile: "new-vgpu"}}, nil),
			req:               &admission.Request{AdmissionRequest: admissionv1.AdmissionRequest{DryRun: ptr.To(false)}},
			wantErr:           true,
		},
		{
			...
			oldVSphereMachine: createVSphereMachineTemplate("foo.com", "vmx-16", "", "", []string{"192.168.0.1/32"}, nil, nil),
			vsphereMachine:    createVSphereMachineTemplate("foo.com", "vmx-16", "", "", []string{"192.168.0.1/32"}, nil, nil),
			req:               &admission.Request{AdmissionRequest: admissionv1.AdmissionRequest{DryRun: ptr.To(false)}},
