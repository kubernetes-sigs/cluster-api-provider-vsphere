...
func ClusterClassTemplateWithKubeVIP() []runtime.Object {
	...
	workerMachineTemplate := newVSphereMachineTemplate(fmt.Sprintf("%s-worker-template", env.ClusterClassNameVar))
	controlPlaneTemplate := newKubeadmControlPlaneTemplate(fmt.Sprintf("%s-kcp", env.ClusterClassNameVar))
	kubeadmJoinTemplate := newKubeadmConfigTemplate(fmt.Sprintf("%s-worker-template", env.ClusterClassNameVar), false)
...
func MultiNodeTemplateWithClusterClassKubeVIP() []runtime.Object {
