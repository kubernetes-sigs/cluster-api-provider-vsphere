...
import (
	...
	aws "sigs.k8s.io/cluster-api-provider-vsphere/pkg/apis/vsphere/v1alpha1/cloud/vmc/aws"
)
...
func (in *VsphereClusterProviderSpec) DeepCopyInto(out *VsphereClusterProviderSpec) {
	*out = *in
	...
	if in.VmwareCloud != nil {
		in, out := &in.VmwareCloud, &out.VmwareCloud
		*out = new(aws.VmwareCloudSpec)
		(*in).DeepCopyInto(*out)
	}
	return
}
