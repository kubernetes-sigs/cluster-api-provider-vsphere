...
var _ = Describe("VirtualMachine tests", func() {
	...
	BeforeEach(func() {
		...
		vmService = VmopMachineService{Client: controllerManagerContext.Client, ConfigureControlPlaneVMReadinessProbe: network.DummyLBNetworkProvider().HasLoadBalancer()}
	})
