...
func TestVSphereMachineSpec(t *testing.T) {
	...
	VSphereMachineStatus := ValidateVSphereMachineSpec(createdclusterSpec, createdmachinespec)
...
func TestVSphereClusterSpec(t *testing.T) {
	...
	VSphereClusterStatus := ValidateVSphereClusterSpec(*createdclusterSpec)
