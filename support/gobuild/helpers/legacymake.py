...
class LegacyMakeHelper(helpers.make.MakeHelper):
    ...
    and GetStorageInfo methods.
       ...
       ...                  helpers.legacymake.LegacyMakeHelper):
    ...
    def _Command(self, hosttype, target, **flags):
        ...
        gotransfer = ('%%(gobuildc) %%(buildid) %s '
                      '%%(buildroot)/legacy/transfer ')
        ...
        defaults = {
            ...
            # 'PUBLISH_DIR' has been used in other gobuild helpers modules for
            # publishing build deliverable. Define it here for consistence.
        ...
        return helpers.make.MakeHelper._Command(self, hosttype,
                                                target, **defaults)
