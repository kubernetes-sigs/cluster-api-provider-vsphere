...
replace sigs.k8s.io/cluster-api => sigs.k8s.io/cluster-api v1.13.0-rc.0

replace sigs.k8s.io/cluster-api/test => sigs.k8s.io/cluster-api/test v1.13.0-rc.0
...
require (
	...
	github.com/vmware-tanzu/vm-operator/external/ncp v0.0.0-20260410045241-141a13693b2a // indirect
