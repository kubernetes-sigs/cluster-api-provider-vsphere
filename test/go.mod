...
replace (
	sigs.k8s.io/cluster-api => sigs.k8s.io/cluster-api v1.14.0-rc.0.0.20260903201830-43fefdcb9046
	sigs.k8s.io/cluster-api-provider-vsphere => ../
	sigs.k8s.io/cluster-api-provider-vsphere/api => ../api
	sigs.k8s.io/cluster-api/api => sigs.k8s.io/cluster-api/api v1.14.0-rc.0.0.20260903201830-43fefdcb9046
	sigs.k8s.io/cluster-api/test => sigs.k8s.io/cluster-api/test v1.14.0-rc.0.0.20260903201830-43fefdcb9046
)
