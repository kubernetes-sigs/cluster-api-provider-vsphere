...
import (
	...
	"sigs.k8s.io/cluster-api-provider-vsphere/test/infrastructure/test-extension/topologymutation"
)
...
var (
	...
	controllerName = "capv-test-extension-manager"
...
func setupTopologyMutationHookHandlers(runtimeExtensionWebhookServer *server.Server) {
	_ = runtimeExtensionWebhookServer
