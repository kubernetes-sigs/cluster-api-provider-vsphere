...
// Package v1alpha1 is a temporary copy from CAPI in-memory provider. We can drop this package as soon as we bump to
// a CAPI version including https://github.com/kubernetes-sigs/cluster-api/pull/9986
package v1alpha1
